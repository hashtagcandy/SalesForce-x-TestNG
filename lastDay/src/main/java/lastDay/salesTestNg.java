 ...
 public static void test() throws InterruptedException {
	//public static <WebElemant> void main(String[] args) throws InterruptedException {
		...
		WebElement uploadFile = driver.findElement(By.xpath("//input[@id='file']"));
				uploadFile.sendKeys("C:\\Users\\CU861FB\\OneDrive - EY\\Desktop\\postman x Salesforce.txt");
		...
		driver.findElement(By.name("file")).sendKeys("C:\\\\Users\\\\CU861FB\\\\OneDrive - EY\\\\Desktop\\\\postman x Salesforce.txt");
